...
public class ComplexSportiv//facade/ punct de acces central UI
{
    ...
    public ComplexSportiv(IStocareDate storage)
    {
        ...
        _terenuri = new GestionareTerenuri(dateTerenuri);

        // 3. Încărcăm rezervările
        var dateRezervari = _storage.Incarca<Rezervare>("rezervari.json");
        _rezervari = new GestionareRezervari(_terenuri, _reguliRezervare, dateRezervari);
    }
